defmodule Hexatube.ContentTest do
  ...
  describe "videos" do
    ...
    @invalid_attrs %{category: nil, name: nil, path: nil, preview_path: nil}
    ...
    test "create_video/1 with valid data creates a video" do
      ...
      valid_attrs = %{category: "some category", name: "some name", path: "some path", preview_path: "some preview"}
    ...
    test "update_video/2 with valid data updates the video" do
      video = video_fixture()
      update_attrs = %{category: "some updated category", name: "some updated name", path: "some updated path", preview_path: "some updated preview"}
