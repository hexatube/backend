defmodule HexatubeWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      HexatubeWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule HexatubeWeb.PageLive do
        use HexatubeWeb, :live_view

        on_mount {HexatubeWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{HexatubeWeb.UserAuth, :ensure_authenticated}] do
